...
/*function showZoomOutNotification() {
  // Display a confirmation dialog
  const userChoice = confirm("It's better when zoomed out. Would you like to zoom out?");

  // If the user clicks "Yes", add the zoom-out effect
  if (userChoice) {
    document.body.classList.add('zoomed-out');
  }
}

// Trigger the notification when the page loads
window.onload = showZoomOutNotification;*/